...
if not os.path.isdir(src):
    print("""
          Dataset non presente nel computer.
          """)
    quit()
...
# Aggiunge un fully connected layer ad un nodo alla fine della rete neurale
input_ = vgg16.input
...
print("""
      ...
      Se l'esecuzione dovesse essere troppo lunga riduci il parametro INPUT_SIZE nel codice per velocizzarlo.
      """)
